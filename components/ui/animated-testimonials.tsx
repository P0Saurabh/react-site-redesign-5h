...
export function AnimatedTestimonials({
  ...
  return (
    <div
      className="mx-auto max-w-sm px-4 py-12 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12"
      role="region"
      aria-label="Animated testimonials"
    >
      <div className="relative grid grid-cols-1 gap-10 md:grid-cols-2">
          ...
          <div className="relative h-80 w-full">
            <AnimatePresence>
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    src={testimonial.src || "/placeholder.svg?height=500&width=500&query=testimonial+photo"}
        ...
        <div className="flex flex-col justify-between py-2">
          ...
          >
            ...
            <motion.p className="mt-6 text-lg text-gray-600 dark:text-neutral-300">
